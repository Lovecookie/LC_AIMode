...
해당 프로젝트는 AI에 관련한 스터디를 하기 위해 제작하였으며 혹시라도 프로젝트에 변경은 다른 브렌치를 이용해
...
응용 프로그램 마법사에서 이 AI_Test 응용 프로그램을 만들었습니다.

AI_Test 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 AI_Test.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
